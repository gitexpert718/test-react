    ...
    <div className = { styles.scene_4_container }>
      <div className="row">
        ...
        <div className="col-12 col-lg-6 defalut_font">
          ...
          <h1><strong className = { styles.strong }><b>Cost & Earning </b><br/>Calculator</strong></h1>
          <p>We've built this instant illustration tools to let you<br/>
          understand how much you will get (Cash Point) from your<br/>
          transaction as well as in long term basis (6, 12 Months).</p>
          <p>
            Download <b>"CONVERT"</b> now and experience a new<br/>
